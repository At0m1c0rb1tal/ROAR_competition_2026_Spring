...
class LatController:
    def run(self, vehicle_location, vehicle_rotation, next_waypoint_location) -> float:
        """
        ...
        steering_command = STEERING_GAIN * math.atan2(
            2.0 * WHEELBASE_METERS * math.sin(alpha) / distance_to_waypoint, 1.0
        )
